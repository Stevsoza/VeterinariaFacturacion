 ...
 * @author Steven
 */
public class AgregarClienteCRUD extends javax.swing.JDialog {
    ...
    public AgregarClienteCRUD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AgregarClienteCRUD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AgregarClienteCRUD dialog = new AgregarClienteCRUD(new javax.swing.JFrame(), true);
